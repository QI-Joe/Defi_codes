...
def abi_csv_writer(csv_write_path : str, file_content : dict):
    target_csv = open(csv_write_path, 'w')
    # if os.stat(csv_write_path).st_size==0:
    csvW = csv.DictWriter(target_csv, file_content.keys())
